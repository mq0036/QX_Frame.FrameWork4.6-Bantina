...
namespace QX_Frame.WebApiIIS.Config
{
    public class ConfigBootStrap
    {
        ...
        {
            JObject jobject_qx_frame_config= IO_Helper_DG.Json_GetJObjectFromJsonFile(QX_Frame.Helper_DG.IO_Helper_DG.RootPath_MVC+ "Config/qx_frame.config.json");//get json configuration file
