...
namespace QX_Frame.Web.Config
{
    public class ConfigBootStrap
    {
        ...
        {
            JObject jobject_qx_frame_config= IO_Helper_DG.Json_GetJObjectFromJsonFile(IO_Helper_DG.RootPath_MVC+@"/Config/qx_frame.config.json");//get json configuration file
